...
public:
    ...
    QRadioButton *radioButton_BM_2;
    QRadioButton *radioButton_VAR_2;
    QPushButton *pushButton_MatchDefault;
    QPushButton *pushButton_MatchChooseFiles;
    QRadioButton *radioButton_SGBM_2;
    ...
    void setupUi(QMainWindow *EvisionClass)
    {
        ...
        graphicsView->setGeometry(QRect(10, 10, 320, 240));
        ...
        graphicsView_2->setGeometry(QRect(340, 10, 320, 240));
        ...
        gridLayout_2->addWidget(horizontalSlider_pyrScale, 7, 0, 1, 2);
        ...
        gridLayout_2->addWidget(horizontalSlider_Levels, 7, 2, 1, 2);
        ...
        gridLayout_2->addWidget(horizontalSlider_PolyN, 7, 4, 1, 2);
        ...
        gridLayout_2->addWidget(horizontalSlider_Lambda, 11, 4, 1, 2);
        ...
        gridLayout_2->addWidget(horizontalSlider_Fi, 11, 2, 1, 2);

        label_29 = new QLabel(groupBox_2);
        label_29->setObjectName(QStringLiteral("label_29"));

        gridLayout_2->addWidget(label_29, 10, 2, 1, 1);
        ...
        gridLayout_2->addWidget(lineEdit_PolySigma, 10, 1, 1, 1);
        ...
        gridLayout_2->addWidget(lineEdit_Fi, 10, 3, 1, 1);
        ...
        gridLayout_2->addWidget(lineEdit_Lambda, 10, 5, 1, 1);
        ...
        gridLayout_2->addWidget(horizontalSlider_PolySigma, 11, 0, 1, 2);
        ...
        radioButton_BM_2 = new QRadioButton(groupBox_5);
        radioButton_BM_2->setObjectName(QStringLiteral("radioButton_BM_2"));

        gridLayout_4->addWidget(radioButton_BM_2, 0, 0, 1, 1);

        radioButton_VAR_2 = new QRadioButton(groupBox_5);
        radioButton_VAR_2->setObjectName(QStringLiteral("radioButton_VAR_2"));

        gridLayout_4->addWidget(radioButton_VAR_2, 4, 0, 1, 1);
        ...
        radioButton_SGBM_2 = new QRadioButton(groupBox_5);
        radioButton_SGBM_2->setObjectName(QStringLiteral("radioButton_SGBM_2"));

        gridLayout_4->addWidget(radioButton_SGBM_2, 1, 0, 1, 1);
        ...
        checkBox_Hartley = new QCheckBox(groupBox_4);
        checkBox_Hartley->setObjectName(QStringLiteral("checkBox_Hartley"));

        gridLayout_5->addWidget(checkBox_Hartley, 3, 0, 1, 1);

        checkBox_Bouguet = new QCheckBox(groupBox_4);
        checkBox_Bouguet->setObjectName(QStringLiteral("checkBox_Bouguet"));

        gridLayout_5->addWidget(checkBox_Bouguet, 0, 0, 1, 1);
    ...
    void retranslateUi(QMainWindow *EvisionClass)
    {
        ...
        radioButton_BM_2->setText(QApplication::translate("EvisionClass", "BM", nullptr));
        radioButton_VAR_2->setText(QApplication::translate("EvisionClass", "VAR", nullptr));
        ...
        radioButton_SGBM_2->setText(QApplication::translate("EvisionClass", "SGBM", nullptr));
        groupBox_4->setTitle(QApplication::translate("EvisionClass", "\346\240\207\345\256\232\347\256\227\346\263\225", nullptr));
        checkBox_Hartley->setText(QApplication::translate("EvisionClass", "Hartley", nullptr));
        checkBox_Bouguet->setText(QApplication::translate("EvisionClass", "Bouguet", nullptr));
