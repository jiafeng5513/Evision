	...
	: QWidget(parent)
{
	...
	connect(m_entity, &StereoMatchParamEntity::paramChanged_BM, this, &StereoMatchView::onParamChanged_BM);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_SGBM, this, &StereoMatchView::onParamChanged_SGBM);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_ELAS, this, &StereoMatchView::onParamChanged_ELAS);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_ADCensus, this, &StereoMatchView::onParamChanged_ADCensus);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_ImageDtoShow, this, &StereoMatchView::onParamChanged_imgDtoShow);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_IconImgL, this, &StereoMatchView::onParamChanged_IconImgL);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_IconImgR, this, &StereoMatchView::onParamChanged_IconImgR);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_IconRawDisp, this, &StereoMatchView::onParamChanged_IconRawDisp);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_IconRainbow, this, &StereoMatchView::onParamChanged_IconRainbow);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_ImageToShow, this, &StereoMatchView::onParamChanged_ImageToShow);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_dMin, this, &StereoMatchView::onParamChanged_DMin);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_dMax, this, &StereoMatchView::onParamChanged_DMax);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_censusWinH, this, &StereoMatchView::onParamChanged_CensusWinH);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_censusWinW, this, &StereoMatchView::onParamChanged_CensusWinW);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_defaultBorderCost, this, &StereoMatchView::onParamChanged_DefaultBorderCost);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_lambdaAD, this, &StereoMatchView::onParamChanged_LambdaAD);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_lambdaCensus, this, &StereoMatchView::onParamChanged_LambdaCensus);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_aggregatingIterations, this, &StereoMatchView::onParamChanged_AggregatingIterations);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_colorThreshold1, this, &StereoMatchView::onParamChanged_ColorThreshold1);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_colorThreshold2, this, &StereoMatchView::onParamChanged_ColorThreshold2);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_maxLength1, this, &StereoMatchView::onParamChanged_MaxLength1);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_maxLength2, this, &StereoMatchView::onParamChanged_MaxLength2);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_colorDifference, this, &StereoMatchView::onParamChanged_ColorDifference);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_pi1, this, &StereoMatchView::onParamChanged_Pi1);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_pi2, this, &StereoMatchView::onParamChanged_Pi2);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_dispTolerance, this, &StereoMatchView::onParamChanged_DispTolerance);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_votingThreshold, this, &StereoMatchView::onParamChanged_VotingThreshold);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_votingRatioThreshold, this, &StereoMatchView::onParamChanged_VotingRatioThreshold);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_maxSearchDepth, this, &StereoMatchView::onParamChanged_MaxSearchDepth);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_cannyThreshold1, this, &StereoMatchView::onParamChanged_CannyThreshold1);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_cannyThreshold2, this, &StereoMatchView::onParamChanged_CannyThreshold2);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_cannyKernelSize, this, &StereoMatchView::onParamChanged_CannyKernelSize);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_blurKernelSize, this, &StereoMatchView::onParamChanged_BlurKernelSize);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_disp_min, this, &StereoMatchView::onParamChanged_DispMin);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_disp_max, this, &StereoMatchView::onParamChanged_DispMax);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_support_threshold, this, &StereoMatchView::onParamChanged_SupportThreshold);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_support_texture, this, &StereoMatchView::onParamChanged_SupportTexture);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_candidate_stepsize, this, &StereoMatchView::onParamChanged_CandidateStepsize);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_incon_window_size, this, &StereoMatchView::onParamChanged_InconWindowSize);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_incon_threshold, this, &StereoMatchView::onParamChanged_InconThreshold);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_incon_min_support, this, &StereoMatchView::onParamChanged_InconMinSupport);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_add_corners, this, &StereoMatchView::onParamChanged_AddCorners);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_grid_size, this, &StereoMatchView::onParamChanged_GridSize);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_beta, this, &StereoMatchView::onParamChanged_Beta);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_gamma, this, &StereoMatchView::onParamChanged_Gamma);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_sigma, this, &StereoMatchView::onParamChanged_Sigma);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_sradius, this, &StereoMatchView::onParamChanged_Sradius);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_match_texture, this, &StereoMatchView::onParamChanged_MatchTexture);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_lr_threshold, this, &StereoMatchView::onParamChanged_LrThreshold);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_speckle_sim_threshold, this, &StereoMatchView::onParamChanged_SpeckleSimThreshold);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_speckle_size, this, &StereoMatchView::onParamChanged_SpeckleSize);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_ipol_gap_width, this, &StereoMatchView::onParamChanged_IpolGapWidth);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_filter_median, this, &StereoMatchView::onParamChanged_FilterMedian);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_filter_adaptive_mean, this, &StereoMatchView::onParamChanged_FilterAdaptiveMean);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_postprocess_only_left, this, &StereoMatchView::onParamChanged_PostprocessOnlyLeft);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_subsampling, this, &StereoMatchView::onParamChanged_SubSampling);

	connect(m_entity, &StereoMatchParamEntity::paramChanged_BM_preFilterType_NORMALIZED, this, &StereoMatchView::onParamChanged_BM_preFilterType_NORMALIZED);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_BM_preFilterType_XSOBEL, this, &StereoMatchView::onParamChanged_BM_preFilterType_XSOBEL);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_BM_preFilterSize, this, &StereoMatchView::onParamChanged_BM_preFilterSize);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_BM_preFilterCap, this, &StereoMatchView::onParamChanged_BM_preFilterCap);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_BM_SADWindowSize, this, &StereoMatchView::onParamChanged_BM_SADWindowSize);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_BM_minDisparity, this, &StereoMatchView::onParamChanged_BM_minDisparity);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_BM_numDisparities, this, &StereoMatchView::onParamChanged_BM_numDisparities);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_BM_textureThreshold, this, &StereoMatchView::onParamChanged_BM_textureThreshold);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_BM_uniquenessRatio, this, &StereoMatchView::onParamChanged_BM_uniquenessRatio);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_BM_speckleRange, this, &StereoMatchView::onParamChanged_BM_speckleRange);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_BM_speckleWindowSize, this, &StereoMatchView::onParamChanged_BM_speckleWindowSize);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_BM_disp12MaxDiff, this, &StereoMatchView::onParamChanged_BM_disp12MaxDiff);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_SGBM_minDisparity, this, &StereoMatchView::onParamChanged_SGBM_minDisparity);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_SGBM_numDisparities, this, &StereoMatchView::onParamChanged_SGBM_numDisparities);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_SGBM_blockSize, this, &StereoMatchView::onParamChanged_SGBM_blockSize);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_SGBM_P1, this, &StereoMatchView::onParamChanged_SGBM_P1);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_SGBM_P2, this, &StereoMatchView::onParamChanged_SGBM_P2);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_SGBM_disp12MaxDiff, this, &StereoMatchView::onParamChanged_SGBM_disp12MaxDiff);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_SGBM_preFilterCap, this, &StereoMatchView::onParamChanged_SGBM_preFilterCap);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_SGBM_uniquenessRatio, this, &StereoMatchView::onParamChanged_SGBM_uniquenessRatio);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_SGBM_speckleWindowSize, this, &StereoMatchView::onParamChanged_SGBM_speckleWindowSize);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_SGBM_speckleRange, this, &StereoMatchView::onParamChanged_SGBM_speckleRange);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_SGBM_MODEL_3WAY, this, &StereoMatchView::onParamChanged_SGBM_MODEL_3WAY);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_SGBM_MODEL_HH4, this, &StereoMatchView::onParamChanged_SGBM_MODEL_HH4);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_SGBM_MODEL_Default, this, &StereoMatchView::onParamChanged_SGBM_MODEL_Default);
	connect(m_entity, &StereoMatchParamEntity::paramChanged_SGBM_MODEL_HH, this, &StereoMatchView::onParamChanged_SGBM_MODEL_HH);
