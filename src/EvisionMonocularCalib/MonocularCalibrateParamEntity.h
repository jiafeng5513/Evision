...
class MonocularCalibrateParamEntity : public QObject
{
	Q_OBJECT

public:
	static MonocularCalibrateParamEntity *getInstance();
	~MonocularCalibrateParamEntity();
private:
	MonocularCalibrateParamEntity(QObject *parent = 0);
